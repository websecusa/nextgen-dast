...
ENHANCED_DEFAULT_SEVERITY = {
    ...
    # ----- Round-12 batch ---------------------------------------------
    # auth & session
    "auth_session_token_entropy":             "medium",
    "auth_session_id_in_url_accepted":        "high",
    "auth_old_session_after_password_change": "high",
    "auth_password_reset_token_reuse":        "high",
    "auth_method_bypass_options_head_trace":  "high",
    "auth_remember_me_token_weak":            "high",
    "auth_oauth_state_missing_or_replay":     "high",
    "auth_mfa_skip_via_state_param":          "high",
    "auth_mfa_no_lockout_on_codes":           "high",
    "auth_jwt_secret_weak_hmac":              "critical",
    "auth_jwt_pii_in_claims":                 "high",
    # authz
    "authz_graphql_field_level":              "high",
    "authz_tenant_id_header_swap":            "high",
    "authz_path_traversal_to_admin":          "high",
    "authz_websocket_unauthenticated":        "high",
    "authz_resource_owner_field_tamper":      "high",
    "authz_object_property_field_inflation":  "high",
    # business logic
    "bizlogic_race_condition_transfer":       "critical",
    "bizlogic_coupon_reuse_or_stack":         "high",
    "bizlogic_negative_quantity_total":       "medium",
    "bizlogic_workflow_skip_payment":         "high",
    "bizlogic_inventory_oversell_race":       "high",
    "bizlogic_self_referral_credit":          "medium",
    "bizlogic_points_negative_redeem":        "medium",
    "bizlogic_rate_limit_bypass_headers":     "medium",
    "bizlogic_subscription_feature_flag_header": "high",
    "bizlogic_email_header_injection":        "medium",
    # injection
    "sqli_second_order_via_profile":          "critical",
    "ldap_injection_login_bypass":            "high",
    "eli_spring_ognl_canary":                 "critical",
    "cmdi_upload_filename_metacharacter":     "critical",
    "header_injection_response_split":        "high",
    "unicode_homoglyph_login":                "high",
    "unicode_overlong_utf8_traversal":        "high",
    # api
    "api_version_legacy_discovery":           "high",
    "api_batch_endpoint_authz_bypass":        "high",
    "api_graphql_dos_nesting":                "medium",
    "api_graphql_alias_amplification":        "medium",
    "api_content_type_confusion":             "high",
    "api_rest_mass_assignment_nested":        "high",
    # file upload
    "upload_extension_bypass_double":         "critical",
    "upload_svg_xss_or_ssrf":                 "high",
    "upload_pdf_external_action":             "medium",
    "upload_zip_symlink":                     "high",
    "upload_zipslip_traversal":               "high",
    "upload_imagemagick_mvg_canary":          "high",
    "upload_decompression_ratio":             "medium",
    # cryptography
    "crypto_padding_oracle_aspnet_axd":       "critical",
    "crypto_timing_token_compare":            "medium",
    "crypto_client_side_encryption_optional": "high",
    # server config
    "ssrf_metadata_endpoint_sweep":           "high",
    "info_powered_by_banner":                 "low",
    "info_git_directory_exposed":             "high",
    "info_svn_directory_exposed":             "high",
    "info_ide_metadata_exposed":              "medium",
    # framework-specific
    "dotnet_viewstate_unencrypted":           "high",
    "dotnet_elmah_axd_exposed":               "high",
    "dotnet_trace_axd_exposed":               "medium",
    "php_type_juggling_magic_hash":           "high",
    "php_array_param_strcmp_bypass":          "high",
    "php_object_injection_canary":            "medium",
    "tomcat_ghostcat_ajp_exposed":            "medium",
    "aem_dispatcher_selector_extension_bypass": "medium",
    "aem_user_enum_home_users":               "high",
    "spring_actuator_exposed":                "critical",
    # client-side
    "clientjs_dom_xss_sinks":                 "high",
    "clientjs_postmessage_no_origin_check":   "medium",
    "clientjs_localstorage_sensitive":        "medium",
    "clientjs_jsonp_callback_reflected":      "high",
    "clientjs_crossdomain_xml_wildcard":      "medium",
    "clientjs_clientaccesspolicy_wildcard":   "medium",
    "clientjs_service_worker_scope":          "medium",
    "clientjs_csp_unsafe_directives":         "medium",
}
...
ENHANCED_OWASP = {
    ...
    # ----- Round-12 batch ---------------------------------------------
    # auth & session → A07
    "auth_session_token_entropy":             "A07:2021-Identification_and_Authentication_Failures",
    "auth_session_id_in_url_accepted":        "A07:2021-Identification_and_Authentication_Failures",
    "auth_old_session_after_password_change": "A07:2021-Identification_and_Authentication_Failures",
    "auth_password_reset_token_reuse":        "A07:2021-Identification_and_Authentication_Failures",
    "auth_method_bypass_options_head_trace":  "A01:2021-Broken_Access_Control",
    "auth_remember_me_token_weak":            "A07:2021-Identification_and_Authentication_Failures",
    "auth_oauth_state_missing_or_replay":     "A07:2021-Identification_and_Authentication_Failures",
    "auth_mfa_skip_via_state_param":          "A07:2021-Identification_and_Authentication_Failures",
    "auth_mfa_no_lockout_on_codes":           "A07:2021-Identification_and_Authentication_Failures",
    "auth_jwt_secret_weak_hmac":              "A02:2021-Cryptographic_Failures",
    "auth_jwt_pii_in_claims":                 "A02:2021-Cryptographic_Failures",
    # authz → A01
    "authz_graphql_field_level":              "A01:2021-Broken_Access_Control",
    "authz_tenant_id_header_swap":            "A01:2021-Broken_Access_Control",
    "authz_path_traversal_to_admin":          "A01:2021-Broken_Access_Control",
    "authz_websocket_unauthenticated":        "A01:2021-Broken_Access_Control",
    "authz_resource_owner_field_tamper":      "A01:2021-Broken_Access_Control",
    "authz_object_property_field_inflation":  "A01:2021-Broken_Access_Control",
    # business logic → A04 (insecure design)
    "bizlogic_race_condition_transfer":       "A04:2021-Insecure_Design",
    "bizlogic_coupon_reuse_or_stack":         "A04:2021-Insecure_Design",
    "bizlogic_negative_quantity_total":       "A04:2021-Insecure_Design",
    "bizlogic_workflow_skip_payment":         "A04:2021-Insecure_Design",
    "bizlogic_inventory_oversell_race":       "A04:2021-Insecure_Design",
    "bizlogic_self_referral_credit":          "A04:2021-Insecure_Design",
    "bizlogic_points_negative_redeem":        "A04:2021-Insecure_Design",
    "bizlogic_rate_limit_bypass_headers":     "A04:2021-Insecure_Design",
    "bizlogic_subscription_feature_flag_header": "A01:2021-Broken_Access_Control",
    "bizlogic_email_header_injection":        "A03:2021-Injection",
    # injection → A03
    "sqli_second_order_via_profile":          "A03:2021-Injection",
    "ldap_injection_login_bypass":            "A03:2021-Injection",
    "eli_spring_ognl_canary":                 "A03:2021-Injection",
    "cmdi_upload_filename_metacharacter":     "A03:2021-Injection",
    "header_injection_response_split":        "A03:2021-Injection",
    "unicode_homoglyph_login":                "A07:2021-Identification_and_Authentication_Failures",
    "unicode_overlong_utf8_traversal":        "A01:2021-Broken_Access_Control",
    # api
    "api_version_legacy_discovery":           "A05:2021-Security_Misconfiguration",
    "api_batch_endpoint_authz_bypass":        "A01:2021-Broken_Access_Control",
    "api_graphql_dos_nesting":                "A05:2021-Security_Misconfiguration",
    "api_graphql_alias_amplification":        "A05:2021-Security_Misconfiguration",
    "api_content_type_confusion":             "A03:2021-Injection",
    "api_rest_mass_assignment_nested":        "A08:2021-Software_and_Data_Integrity_Failures",
    # file upload
    "upload_extension_bypass_double":         "A03:2021-Injection",
    "upload_svg_xss_or_ssrf":                 "A03:2021-Injection",
    "upload_pdf_external_action":             "A10:2021-Server_Side_Request_Forgery",
    "upload_zip_symlink":                     "A01:2021-Broken_Access_Control",
    "upload_zipslip_traversal":               "A01:2021-Broken_Access_Control",
    "upload_imagemagick_mvg_canary":          "A10:2021-Server_Side_Request_Forgery",
    "upload_decompression_ratio":             "A05:2021-Security_Misconfiguration",
    # cryptography → A02
    "crypto_padding_oracle_aspnet_axd":       "A02:2021-Cryptographic_Failures",
    "crypto_timing_token_compare":            "A02:2021-Cryptographic_Failures",
    "crypto_client_side_encryption_optional": "A02:2021-Cryptographic_Failures",
    # server config
    "ssrf_metadata_endpoint_sweep":           "A10:2021-Server_Side_Request_Forgery",
    "info_powered_by_banner":                 "A05:2021-Security_Misconfiguration",
    "info_git_directory_exposed":             "A05:2021-Security_Misconfiguration",
    "info_svn_directory_exposed":             "A05:2021-Security_Misconfiguration",
    "info_ide_metadata_exposed":              "A05:2021-Security_Misconfiguration",
    # framework-specific
    "dotnet_viewstate_unencrypted":           "A08:2021-Software_and_Data_Integrity_Failures",
    "dotnet_elmah_axd_exposed":               "A05:2021-Security_Misconfiguration",
    "dotnet_trace_axd_exposed":               "A05:2021-Security_Misconfiguration",
    "php_type_juggling_magic_hash":           "A07:2021-Identification_and_Authentication_Failures",
    "php_array_param_strcmp_bypass":          "A07:2021-Identification_and_Authentication_Failures",
    "php_object_injection_canary":            "A08:2021-Software_and_Data_Integrity_Failures",
    "tomcat_ghostcat_ajp_exposed":            "A05:2021-Security_Misconfiguration",
    "aem_dispatcher_selector_extension_bypass": "A05:2021-Security_Misconfiguration",
    "aem_user_enum_home_users":               "A01:2021-Broken_Access_Control",
    "spring_actuator_exposed":                "A05:2021-Security_Misconfiguration",
    # client-side
    "clientjs_dom_xss_sinks":                 "A03:2021-Injection",
    "clientjs_postmessage_no_origin_check":   "A03:2021-Injection",
    "clientjs_localstorage_sensitive":        "A02:2021-Cryptographic_Failures",
    "clientjs_jsonp_callback_reflected":      "A03:2021-Injection",
    "clientjs_crossdomain_xml_wildcard":      "A05:2021-Security_Misconfiguration",
    "clientjs_clientaccesspolicy_wildcard":   "A05:2021-Security_Misconfiguration",
    "clientjs_service_worker_scope":          "A08:2021-Software_and_Data_Integrity_Failures",
    "clientjs_csp_unsafe_directives":         "A05:2021-Security_Misconfiguration",
}
